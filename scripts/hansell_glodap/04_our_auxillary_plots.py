...
# VARS = ['NPP_EPPL', 'NPP_CBPM', 'EF_EPPL', 'EF_CBPM', 'EP_EPPL', 'EP_CBPM']
...
VARS_lab = {'NPP_EPPL': "NPP$_{Eppley}$ [mg C m$^{-2}$ d$^{-1}$]",
            ...
            'EF_EPPL': "ef-ratio$_{Eppley}$",
            'EF_CBPM': "ef-ratio$_{CbPM}$",
            'EP_EPPL': "EP$_{Eppley}$ [mg C m$^{-2}$ d$^{-1}$]",
            'EP_CBPM': "EP$_{CbPM}$ [mg C m$^{-2}$ d$^{-1}$]"}
