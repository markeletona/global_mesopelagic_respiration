...
# fpath = 'deriveddata/hansell_glodap/hansell_glodap_merged_o2_cfc11_cfc12_sf6_with_ages - Copy.csv'
# tbl = pd.read_csv(fpath, sep=",", header=0, dtype={'EXPOCODE': str,
#                                                     'CRUISE': str,
#                                                     'BOTTLE': str,
#                                                     'DATE': int})

# px_arazoa = 'pacific;intermediate;AAIW_P;-160.0;-30.0;-150.0;-20.0'
# tbl_berria_arazoa = tbl_berria.loc[tbl_berria.PIXEL==px_arazoa,:]
# tbl_zaharra_arazoa = tbl_zaharra.loc[tbl_zaharra.PIXEL==px_arazoa,:]

# froga = tbl_berria.loc[tbl_berria.EXPOCODE=='320620140320',:]
