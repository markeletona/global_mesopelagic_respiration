...
fig.savefig(fpath, format='png', bbox_inches='tight', dpi=600)
        ...
        #     # Store also locations of the data points (i.e. samples) with VALID 
        #     # values of each variable (to add as scatter plot over the contour):
        #     nn[zname] = notnan
        
        # else: # if no valid values, fill with nans
        #     rvalues[zname] = np.empty([ndim, ndim])*np.nan
        #     nn[zname] = notnan
