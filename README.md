...
1. Install the conda environment specified in the `.yml` file (`oceanicu.yml`). If you need help with to do it, see [this](https://docs.conda.io/projects/conda/en/latest/user-guide/tasks/manage-environments.html#creating-an-environment-from-an-environment-yml-file).
